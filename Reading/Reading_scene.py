...
class ReadingScene:
    ...
    def __init__(self, scene_data_path, motion_data_path, wonder = True):
        ...
        # there's 10
        temp_scene_object_ids = ["nurbsSphere1", "nurbsSphere2", "nurbsSphere3", "nurbsSphere4", "nurbsSphere5", "nurbsSphere6", "nurbsSphere7", "nurbsSphere8", "nurbsSphere9", "nurbsSphere10"]
